...
{
    _rwlock = static_cast<void*>(new std::shared_mutex);
}
...
{
    static_cast<std::shared_mutex*>(_rwlock)->lock_shared();
}

void ThreadRWLock::writeLock()
{
    static_cast<std::shared_mutex*>(_rwlock)->lock();
}

void ThreadRWLock::unReadLock()
{
    static_cast<std::shared_mutex*>(_rwlock)->unlock_shared();
}

void ThreadRWLock::unWriteLock()
{
    static_cast<std::shared_mutex*>(_rwlock)->unlock();
}
