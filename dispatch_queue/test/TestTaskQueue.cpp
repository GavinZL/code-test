...
int main(int argc, char* argv[])
{
    ...
    // 同步任务
    printf("-------------------------------------- 同步任务 --------------------------------------\n");
    auto queue3 = TaskQueueFactory::GetInstance().globalParallelQueue(TaskQueuePriority::TQP_Normal);
    queue3->sync([]() {
    ...
    // 延时任务
    printf("---------------------------延时任务----------------------------\n");
    auto queue4 = TaskQueueFactory::GetInstance().globalParallelQueue(TaskQueuePriority::TQP_Normal);
